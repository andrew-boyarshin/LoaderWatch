...
#define INJ_PATH_MEMORY_TAG 'PjnI'
...
typedef struct _INJ_INJECTION_INFO
{
  ...
  BOOLEAN     PathAllocated;

  BOOLEAN SuppressInjectionOnModuleLoad;
  BOOLEAN IndirectInjection;
  BOOLEAN LogAllOpenKey;
  ...
  UNICODE_STRING InjectionDllPath;
