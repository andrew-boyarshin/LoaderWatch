...
namespace LoaderWatch.Library.NativeDebug
{
	public class IA64Context : INativeContext, IEquatable<INativeContext>, IDisposable
    {
        ...
        private IA64Context(INativeContext ctx)
        {
            ...
            using (var w = ctx.OpenForDirectAccess())
            {
        ...
        private void InitializeContext()
        {
            ...
            this.m_imageFileMachine = (int) NativeDebug.ImageFileMachine.IA64;
            this.m_rawPtr = Marshal.AllocHGlobal(this.Size);
        ...
        public void ClearContext()
        {
            ...
            using (var w = this.OpenForDirectAccess())
            {
        ...
        public ContextFlags GetPSFlags(AgnosticContextFlags flags)
        {
            ...
            this.m_platform = Platform.IA64;
			var cFlags = ContextFlags.IA64Context;
        ...
        public IntPtr InstructionPointer
        {
            get
            {
                ...
                using (var w = this.OpenForDirectAccess())
                {
					var iip = Marshal.ReadInt64(w.RawBuffer, (int)IA64Offsets.StIIP);

					var StIPSR = Marshal.ReadInt64(w.RawBuffer, (int)IA64Offsets.StIPSR);
                    int PSR_RI = (int)IA64Flags.PSR_RI;
					var slot = (StIPSR >> PSR_RI) & 3;
                    iip |= slot << 2;
            ...
            set
            {
                ...
                {
                    UInt64 ipsr = 0;
					var iip = (UInt64)value.ToInt64();

					// slot = iip & (IA64_BUNDLE_SIZE - 1) >> 2
					var slot = ((UInt64)iip) & ((int)IA64Flags.IA64_BUNDLE_SIZE - 1) >> 2;
        ...
        public void SetSingleStepFlag(bool fEnable)
        {
            if (fEnable)
            {
				var stipsr = Marshal.ReadInt64(this.RawPtr, (int)IA64Offsets.StIPSR) | (Int64)IA64Flags.SINGLE_STEP_FLAG;
