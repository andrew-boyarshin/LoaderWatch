...
namespace LoaderWatch.Library.MemorySharp.Modules
{
    /// <summary>
    ...
    public class ModuleFactory : IFactory
    {
        #region Fields
        /// <summary>
        /// The reference of the <see cref="Library.MemorySharp.MemorySharp"/> object.
        /// </summary>
        ...
        private RemoteModule _mainModule;
	        ...
	        get
	        {
				if (_mainModule == null)
				{
					try
					{
						...
						_mainModule = FetchModule(MemorySharp.Native.MainModule);
					}
					catch (Exception)
					{
						return null;
