...
using LoaderWatch.Library.MemorySharp.Assembly.Assembler;
using LoaderWatch.Library.MemorySharp.Assembly.CallingConvention;
...
namespace LoaderWatch.Library.MemorySharp.Assembly
{
    /// <summary>
