...
using LoaderWatch.Library.MemorySharp.Windows.Keyboard;
using LoaderWatch.Library.MemorySharp.Windows.Mouse;

namespace LoaderWatch.Library.MemorySharp.Windows
{
    /// <summary>
